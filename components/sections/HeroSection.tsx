    ...
    >
      ...
      <div className="container-wide relative z-10 pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="max-w-3xl">
          ...
          <h1 className="mb-6" style={{ fontSize: "var(--font-display)", fontWeight: 600, lineHeight: 1.05, letterSpacing: "-0.02em", fontFamily: "var(--font-geist-sans)" }}>
            {words.map((word, i) => (
              <motion.span
                key={i}
          ...
          >
            ...
            <Link
              ...
              style={{ color: "var(--text-primary)", borderColor: "var(--border-strong)", background: "transparent" }}
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <span className="text-xs tracking-wider" style={{ color: "var(--text-muted)", letterSpacing: "0.05em", fontSize: "11px" }}>
          {t.hero.scroll}
        </span>
        <div className="flex flex-col gap-1">
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{ background: "var(--accent)", animation: `pulse-dot 1.5s ease-in-out infinite`, animationDelay: `${i * 0.2}s` }}
            />
          ))}
        </div>
      </motion.div>
